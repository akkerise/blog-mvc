                    ...
                    foreach ($music as $music) {
                        ...
                        <div class="col-md-6 blog-grid">
                            <div class="blog-grid-left1">
                                <a href="singlepage.html"><img src="<?php echo URL ?>images/blog/<?php echo $music["image"] ?>" alt=" "
                                                               class="img-responsive"></a>
                            </div>
                            <div class="blog-grid-right1">
                                <a href="singlepage.html"><?php echo $music["name_blog"] ?></a>
                                <h4><?php echo $music["date"] ?></h4>
