            ...
            <div class="agileinfo">
                ...
                <div class="single">
                    ...
                    <div class="b-bottom">
                        ...
                        <p><?php echo $detail["created_at"] ?><a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span><?php echo $detail["total_comments"] ?>
                            </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span><?php echo $detail["views"] ?> </a>
                        </p>
                    ...
                    foreach ($comments as $comments) {
                        ...
                        <div class="media response-info">
                            <div class="media-left response-text-left">
                                <a href="#">
                                    <img src="<?php echo URL ?><?php echo $comments["avatar"] ?>" class="img-responsive" alt="">
                                </a>
                            </div>
                            <div class="media-body response-text-right">
                                ...
                                <div class="media response-info">
                                    <div class="media-left response-text-left">
                                        <a href="#">
                                            <img src="<?php echo URL ?>images/sin2.jpg" class="img-responsive" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body response-text-right">
                    ...
                    if (isset($_SESSION["login"])) {
                        ...
                        <form action="#" method="post">
                            ...
                            <textarea onfocus="this.value = '';"
                                      onblur="if (this.value == '') {this.value = 'Your Comment...';}" required="" id="comment-detail">Your Comment...</textarea>
                            <input type="submit" value="Submit Comment" onclick="submitComment(<?php echo $detail["blog_id"] ?>, <?php echo $_SESSION["id_user"] ?>)">
                        </form>
                        <?php
                    } else {
                        ?>
